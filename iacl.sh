...
echo "Criando usuários e já adicionando-os aos grupos..."
...
useradd sebastiao -m -s /bin/bash -p $(openssl passwd -crypt senha123) -G groupadd GRP_VEN
useradd roberto -m -s /bin/bash -p $(openssl passwd -crypt senha123) -G groupadd GRP_VEN
